...
postComment.click( function (e) {
	...
	var commenterName = inputComment.attr('commenterName');
	...
	$.post(action, data, function (d) {
		...
		comment = prepareUpdateHTML(newComment, id, commenter, commenterName, edittoken, deltoken, time, edited);
...
var prepareUpdateHTML = function (newComment, id, commenter, commenterName, edittoken, deltoken, time, edited) {
	...
	comment = '<div class="maincontainer one-comment" id="single-comment-' + id + '"><div class="leftcolumn commenter-info"><img src="' + commenter + '" class="commenter-avatar img-responsive"></div><div class="contentwrapper comment-body"><p class="comment-text" id="comment-text-' + id + '">' + newComment + '</p><p class="comment-info"> <span class="comment-name truncate" id="comment-name-' + id + '"> ' + commenterName + ' </span> <span class="comment-time" id="comment-time-' + id + '"> just now.</span><span class="comment-edited" id="edited-' + id +'"></span><a href="#" title="Edit" class="pull-right comment-form-openers" comment="' + id + '" for="edit-comment-' + id + '" id="open-edit-for-' + id +'"> <i class="fa fa-edit"></i></a><a href="#" title="Delete" class="pull-right comment-form-openers delete" comment="' + id + '" for="delete-comment-' + id + '" id="open-delete-for-' + id + '"> <i class="fa fa-trash"></i></a></p></div></div>';
